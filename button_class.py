...
class Button:
    def __init__(self, surface, x, y, width, height, state='', id='', function=0, colour=(106, 158, 117),
                 hover_colour=(72, 107, 79), border=True, border_width=2, border_colour=(0,0,0),
                 font_name='arial', text_size=20, text_colour=(255,255,255), bold_text=True, text=None):
        self.type = 'button'
        self.x = x
        self.y = y
        self.pos = vec(x, y)
    ...
    def click(self):
        if (self.function != None) and (self.hovered):
            self.function()
